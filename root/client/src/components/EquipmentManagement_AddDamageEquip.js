...
export default function AddDamageEquip() { 
    ...
    function sendData(e){
        e.preventDefault();
        const newequipment={damageId,equipmentno,equipmentname,damagedescription,technicianname,technicianemail,assigneddate,deliverydate,repaircost}
        ...
        <div className="container mt-5">
            <form className="mx-auto w-50 shadow p-5" onSubmit={sendData}>
                ...
                <div className="mb-3">
                    ...
                    <input type="email" className="form-control" id="purchase_to_be_made" placeholder="Enter Purchase To Be Made" name="purchasetobemade" value={technicianemail} onChange={(e) => {setTechnicianEmail(e.target.value);}} required/>
                </div>
                <div className="mb-3">
