    ...
    <Sidebar>
      ...
      <Routes>
        <Route
          ...
          exact
          element={<EquipmentManagement_Navbar />}
        />
      </Routes>
      <Routes>
        <Route
          path="/Equipment_Management/addEquipment"
          element={<EquipmentManagement_AddEquipment />}
        />
        <Route
          path="/Equipment_Management/editEquipment/:equipmentno"
          element={<EquipmentManagement_EditEquipment />}
        />
        <Route
          path="/Equipment_Management/delete/:equipmentno"
          element={<EquipmentManagement_DeleteEquipment />}
        />
        <Route
          path="/Equipment_Management/"
          element={<EquipmentManagement_AllEquipment />}
        />
        <Route
          path="/Equipment_Management/add"
          element={<EquipmentManagement_AddDamageEquip />}
        />
        <Route
          path="/Equipment_Management/editDamageEquipment/:damageId"
          element={<EquipmentManagement_EditDamageEquip />}
        />
        <Route
          path="/Equipment_Management/deleteDamage/:damageId"
          element={<EquipmentManagement_DeleteDamageEquip />}
        />
        <Route
          path="/Equipment_Management/damage"
          element={<EquipmentManagement_AllDamageEquip />}
        />
        <Route
          path="/Equipment_Management/t"
          element={<EquipmentManagement_TechnicianEmail />}
        />
        <Route
          path="/Equipment_Management/addReservation"
          element={<EquipmentManagement_AddEquipmentReservation />}
        />
        <Route
          path="/Equipment_Management/allReservation"
          element={<EquipmentManagement_AllEquipmentReservation />}
        />
        <Route
          path="/Equipment_Management/editEquipmentReservation/:reservationId"
          element={<EquipmentManagement_EditEquipmentReservation />}
        />
        <Route
          path="/Equipment_Management/cancelReservation/:reservationId"
          element={<EquipmentManagement_CancelReservation />}
        />
        <Route
          path="/Equipment_Management/equipmentHome"
          element={<EquipmentManagement_EquipmentHome />}
        />
      </Routes>
      {/*end*/}
