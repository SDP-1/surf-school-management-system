...
let DamageEquipment = require("../models/SupplierManagement_damageEquipment");
...
router.route("/editDamageEquipment/:damageId").put(async(req,res)=>{
     //create a variable for store id
      ...
      const{ damageId,equipmentno, equipmentname,damagedescription,suppliername,supplieremail,technicianname,technicianemail,assigneddate, deliverydate,repaircost}=req.body;//destructure
...
//get data from one damaged equipment
