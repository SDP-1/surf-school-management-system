...
const Equipment = require("../models/SupplierManagement_equipment");
...
//route for read
router.route("/allequipment").get((req,res)=>{
...
router.route("/editEquipment/:equipmentno").put(async(req,res)=>{
     //create a variable for store id
      ...
      const{equipmentno,equipmentname,equipmentdescription,quantityinstock,quantityrequired,purchasetobemade,availableequipment,rentalequipment,damageequipment,suppliername,supplieremail}=req.body;//destructure
